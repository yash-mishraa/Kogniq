...
def main() -> None:
    ...
    blocks = [
        ...
        NormalizedBlock(
            block_id="b2", block_type=BlockType.HEADING, text="Linear Algebra", order=1
        ),
        NormalizedBlock(
            block_id="b3",
            block_type=BlockType.PARAGRAPH,
        ...
        NormalizedBlock(block_id="b4", block_type=BlockType.HEADING, text="Vectors", order=3),
        NormalizedBlock(
            block_id="b5",
            block_type=BlockType.PARAGRAPH,
        ...
        NormalizedBlock(
            block_id="b6", block_type=BlockType.LIST, text="- Direction\n- Magnitude", order=5
        ),
        NormalizedBlock(block_id="b7", block_type=BlockType.HEADING, text="Matrices", order=6),
        NormalizedBlock(
            block_id="b8",
            block_type=BlockType.PARAGRAPH,
        ...
        NormalizedBlock(block_id="b9", block_type=BlockType.HEADING, text="Probability", order=8),
        NormalizedBlock(
            block_id="b10",
            block_type=BlockType.PARAGRAPH,
            text=(
        ...
        NormalizedBlock(block_id="b11", block_type=BlockType.HEADING, text="Bayes Rule", order=10),
        NormalizedBlock(
            block_id="b12",
            block_type=BlockType.PARAGRAPH,
            text=(
