...
describe("Workspace Engine foundation", () => {
  it("registers every metadata-only environment", () => {
    expect(environmentRegistry.listEnvironments().map(e => e.id)).toEqual(["documents", "graph", "knowledge", "search", "studio", "study", "notebook", "flashcards", "quiz", "analytics", "learningHub"]);
