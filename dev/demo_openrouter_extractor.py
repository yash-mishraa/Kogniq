...
def main() -> None:
    ...
    if not api_key:
        print("Skipping extraction demo: OPENROUTER_API_KEY not found in environment.")
        return

    print("Initializing OpenRouter Knowledge Extractor...")
    extractor = OpenRouterKnowledgeExtractor(api_key=api_key)
