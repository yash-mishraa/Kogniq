...
export function Skeleton({ className }: { className?: string }) { return <div aria-label="Loading" role="status" className={cn("animate-pulse rounded-xs bg-raised", className)} />; }
