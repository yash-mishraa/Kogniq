...
- **Key Concepts**: `ResourceHandle`, `LearningResource`, `ResourceSection`, `Chunk`, `ChunkCollection`, `AbstractChunkStrategy`, `ContentProcessingPipeline`, `ProcessorRegistry`, `NormalizedDocument`.
